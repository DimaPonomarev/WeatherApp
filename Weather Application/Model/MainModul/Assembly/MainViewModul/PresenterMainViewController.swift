...
protocol MainViewControllerPresenterProtocol: AnyObject {
    ...
    func responseFromInteractor(model: ForecastWeather)
...
class MainViewControllerPresenter: MainViewControllerPresenterProtocol {
    ...
    public func responseFromInteractor(model: ForecastWeather) {
...
private extension MainViewControllerPresenter {
    ...
    func convertDataToTopViewModel(dataSource: ForecastWeather) -> ModelForTopView {
    ...
    func convertDataToCollectionViewModel(dataSource: ForecastWeather?) -> [ModelForCollectionView] {
    ...
    func convertDataToTableViewModel(dataSource: ForecastWeather?) -> [ModelForTableView] {
    ...
    func getCurrentLocalDate(in chosenLocation: ForecastWeather.CurrentLocation) -> String {
